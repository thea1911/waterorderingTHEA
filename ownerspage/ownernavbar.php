...
<head>
    ...
    <link rel="stylesheet" href="ownernavbar.css" />
...
<nav>
        ...
        <div class="nav__menu">
            <ul class="nav__links">
              <li class="<?php echo $current_page == 'ownerpage.php' ? 'active' : ''; ?>"><a href="ownerpage.php">HOME</a></li>
              <li class="<?php echo $current_page == 'products.php' ? 'active' : ''; ?>"><a href="products.php">PRODUCTS</a></li>
              <li class="<?php echo $current_page == 'sales.php' ? 'active' : ''; ?>"><a href="sales.php">SALES</a></li>
              <li class="<?php echo $current_page == 'orders.php' ? 'active' : ''; ?>"><a href="orders.php">ORDERS</a></li>
            </ul>
            <div class="profile">
                <div class="profile-dropdown">
                    <img src="image/<?php echo $profileImage; ?>?v=<?php echo time(); ?>" alt="Profile Pic" onclick="toggleDropdown()" class="profile-pic" style="width: 50px; height: 50px;" />
